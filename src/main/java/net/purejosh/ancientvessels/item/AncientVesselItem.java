...
public class AncientVesselItem extends SwordItem {
	public AncientVesselItem() {
		super(new Tier() {
			public int getUses() {
				return 784;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77A sword that serves as a"));
		list.add(Component.literal("\u00A77container for ancient energy."));
	}
}
